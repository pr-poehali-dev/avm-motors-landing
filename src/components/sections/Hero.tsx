        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-4 md:mb-6 leading-[0.95] tracking-tight relative max-w-3xl lg:max-w-4xl">
                АВТОМОБИЛИ<br />
              ...
              <div className="flex flex-row gap-4 md:gap-6 relative z-30">
                <Button 
                  size="lg" 
