      ...
      <div className="w-full px-4 sm:px-6 lg:px-12 relative py-8 md:py-16 z-20">
        <div className="relative">
          <div className="mb-8 flex gap-3 sm:gap-4">
            ...
            >
              <Icon name="Car" size={18} className="sm:w-[22px] sm:h-[22px]" />
              <span className="hidden xs:inline">Автомобили</span>
              <span className="xs:hidden">Авто</span>
            </button>
            <button
            ...
            >
              <Icon name="Bike" size={18} className="sm:w-[22px] sm:h-[22px]" />
              <span className="hidden xs:inline">Мототехника</span>
              <span className="xs:hidden">Мото</span>
            </button>
          </div>
