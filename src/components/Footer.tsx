        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 mb-8 lg:mb-16">
          <div className="lg:col-span-5 flex flex-col items-center lg:items-start">
            ...
            <div className="flex gap-3 lg:gap-4 mt-4 lg:mt-0">
              <a href="https://t.me/+_ZSslTyv3xg3MDky" target="_blank" rel="noopener noreferrer" className="w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-accent/10 flex items-center justify-center hover:bg-accent/20 transition-colors group" aria-label="Наш Telegram канал">
                <Icon name="Send" size={20} className="text-accent lg:w-[22px] lg:h-[22px]" />
              </a>
              <a href="https://www.tiktok.com/@avmmotors1" target="_blank" rel="noopener noreferrer" className="w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-accent/10 flex items-center justify-center hover:bg-accent/20 transition-colors group" aria-label="Наш TikTok аккаунт">
          ...
          <div className="lg:col-span-3">
            <h3 className="text-xs lg:text-sm font-bold mb-4 lg:mb-6 tracking-[0.2em] uppercase text-muted-foreground">Навигация</h3>
          ...
          <div className="lg:col-span-4">
            <h3 className="text-xs lg:text-sm font-bold mb-4 lg:mb-6 tracking-[0.2em] uppercase text-muted-foreground">Связь</h3>
